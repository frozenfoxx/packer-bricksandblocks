   ...
   <settings pass="oobeSystem">
      <component xmlns:wcm="http://schemas.microsoft.com/WMIConfig/2002/State" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" name="Microsoft-Windows-Shell-Setup" processorArchitecture="amd64" publicKeyToken="31bf3856ad364e35" language="neutral" versionScope="nonSxS">
         ...
         <FirstLogonCommands>
            ...
            <SynchronousCommand wcm:action="add">
               <CommandLine>%SystemRoot%\system32\WindowsPowerShell\v1.0\powershell.exe -File F:\windows-net-static_ip.ps1 -IpAddress "${vm_net_ip}" -PrefixLength ${vm_net_prefix} -DefaultGateway "${vm_net_gateway}"</CommandLine>
               <Order>4</Order>
               <Description>Set IP address</Description>
            </SynchronousCommand>
            <SynchronousCommand wcm:action="add">
               <CommandLine>%SystemRoot%\system32\WindowsPowerShell\v1.0\powershell.exe F:\windows-net-dns.ps1 -DnsPrimary "${vm_net_dns_primary}" -DnsSecondary "${vm_net_dns_secondary}"</CommandLine>
               <Order>5</Order>
               <Description>Set DNS servers</Description>
            </SynchronousCommand>
            <SynchronousCommand wcm:action="add">
               <CommandLine>%SystemRoot%\system32\WindowsPowerShell\v1.0\powershell.exe -File F:\windows-rm-enable.ps1</CommandLine>
               <Order>6</Order>
