...
variable "vm_inst_os_key_standard" {
  ...
  default     = env("WINDOWS_SERVER_OS_KEY_STANDARD")
  sensitive   = true
}
...
variable "vm_inst_os_key_datacenter" {
  ...
  default     = env("WINDOWS_SERVER_OS_KEY_DATACENTER")
  sensitive   = true
}
...
variable "vm_net_dns_primary" {
  type        = string
  description = "Primary DNS server"
  default     = "1.1.1.1"
}

variable "vm_net_dns_secondary" {
  type        = string
...
variable "build_username" {
  ...
  default     = env("WINDOWS_SERVER_OS_USER")
  sensitive   = true
}
...
variable "build_password" {
  ...
  default     = env("WINDOWS_SERVER_OS_PASSWORD")
  sensitive   = true
}
...
variable "build_password_encrypted" {
  ...
  default     = env("WINDOWS_SERVER_OS_PASSWORD_SHA512")
  sensitive   = true
}
...
variable "build_key" {
  ...
  default     = env("SSH_PRIVATE_KEY_FILE_NAME")
  sensitive   = true
}
...
variable "root_dir" {
  type        = string
  description = "Directory root of the repository"
  default     = env("ROOT_DIR")
}
